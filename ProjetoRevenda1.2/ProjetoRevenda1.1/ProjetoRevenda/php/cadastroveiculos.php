...
if (isset($_POST['gravar']))
{
    ...
    $sql ="INSERT INTO marca (codigo,nome,codmodelo, ano, cor, opcionais, valor)
    VALUES ('$codigo', '$nome', '$codmarca', '$ano', '$cor', '$opcionais', $valor)";
...
if (isset($_POST['excluir']))
{
    ...
    $sql ="DELETE FROM modelos (codigo,nome,codmarca)
    WHERE codigo = '$codigo'";
...
//capturar as variaves do html
    ...
    $sql ="UPDATE marca SET nome='$nome', descricao='$'
    WHERE codigo = '$codigo' and codmarca = '$codmarca'";
