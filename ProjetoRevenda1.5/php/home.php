...
<body> 
    <header class="cabecalho"> 
        ...
        <nav class="cabecalho__sub"> 
            <a class="cabecalho__sub__link" href="../cadastroUsuariosT.html">   Criar login </a>
            ...
            <a class="cabecalho__sub__link" href="../cadastroVeiculos.html">    Veiculos    </a>
        </nav>
    </header>
<main class="container">
    <div class="forms"> 
    <section class="formulario__separacao" style="flex-direction: column; justify-content: center;">
        <form class ="forms__formularios__php"name='formulario' method="post" action="home.php">
